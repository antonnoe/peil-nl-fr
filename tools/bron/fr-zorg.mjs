...
{ id: 'p.fr.secu.brss_consult_medecin_traitant', nl: 'Base de remboursement consult huisarts', fr: 'Base de remboursement, consultation du médecin traitant', off: 'Tarif conventionnel secteur 1',
...
{ id: 'p.fr.secu.brss_kine_per_sessie', nl: 'Base de remboursement kinesitherapie per sessie', fr: 'Base de remboursement, séance de kinésithérapie', off: null,
  reg: 'fr.secu', klasse: 'overheid_vastgesteld', effect: 'bepaalt_grondslag', eh: 'EUR', jaar: '2025',
  freq: 'onregelmatig',
  in: [[ 'zorgkompas-frankrijk', 'scenarios.js:62 en 106', '16,13', false ]] },

{ id: 'p.fr.secu.vergoedingspercentage_standaard', nl: 'Standaard vergoedingspercentage Sécurité sociale', fr: 'Taux de remboursement de droit commun', off: null,
...
{ id: 'p.fr.secu.vergoeding_kine_en_medicatie', nl: 'Vergoeding kinesitherapie en medicatie', fr: 'Taux de remboursement, kinésithérapie et médicaments', off: null,
  reg: 'fr.secu', klasse: 'overheid_vastgesteld', effect: 'verlaagt_last', eh: 'fractie', jaar: '2026',
  freq: 'onregelmatig',
  in: [[ 'zorgkompas-frankrijk', 'scenarioEngine.js:89-90', '0,60 respectievelijk 0,65', false ]] },

{ id: 'p.fr.secu.vergoeding_had_en_infirmiere', nl: 'Vergoeding thuisziekenhuis en verpleging aan huis', fr: 'Taux de remboursement, HAD et infirmière libérale', off: null,
  reg: 'fr.secu', klasse: 'overheid_vastgesteld', effect: 'verlaagt_last', eh: 'procent', jaar: '2026',
  freq: 'onregelmatig',
  in: [[ 'cafeclaude', 'lib/domains/prompts/zorg.ts:112-113', 'HAD 80 procent of 100 procent bij ALD; infirmière 70 procent Secu plus 30 procent mutuelle', false ]] },
...
{ id: 'p.fr.secu.franchise_medicale', nl: 'Franchise médicale per medicijn', fr: 'Franchise médicale par boîte de médicaments', off: 'Art. L160-13 III CSS',
  reg: 'fr.secu', klasse: 'overheid_vastgesteld', effect: 'verhoogt_last', eh: 'EUR', jaar: '2026',
  freq: 'onregelmatig', lw: '2024-05-01',
...
{ id: 'p.fr.assur.bonus_malus_auto', nl: 'Bonus-malus autoverzekering', fr: 'Coefficient de réduction-majoration', off: 'Annexe à l\'art. A121-1 Code des assurances',
...
{ id: 'p.fr.apa.bedrag_per_maand', nl: 'APA-bedrag per maand', fr: 'Montant de l\'APA par mois', off: 'Allocation personnalisée d\'autonomie, plafonds par GIR',
...
{ id: 'p.fr.aspa.maximum_alleenstaand', nl: 'ASPA maximum voor een alleenstaande', fr: 'ASPA, montant maximal pour une personne seule', off: 'Allocation de solidarité aux personnes âgées',
...
{ id: 'p.fr.zorg.teleassistentie_maandprijs', nl: 'Teleassistentie, maandprijs', fr: 'Téléassistance, prix mensuel', off: null,
...
{ id: 'p.fr.zorg.mandat_protection_future_kosten', nl: 'Mandat de protection future, kosten', fr: 'Mandat de protection future, coût', off: null,
