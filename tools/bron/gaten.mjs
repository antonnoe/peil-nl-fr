...
// ------------------------------------------------------------------- NL fiscaal
G('p.nl.ib.aow_leeftijd', 'AOW-leeftijd', 'Âge de la retraite AOW', 'AOW-leeftijd per geboortejaar', 'nl.ib', 'jaren en maanden', 'bepaalt_toepasselijkheid',
...
G('p.nl.ib.ouderenkorting', 'Ouderenkorting', 'Crédit d\'impôt pour personnes âgées', 'Ouderenkorting', 'nl.ib', 'EUR', 'verlaagt_last',
...
G('p.nl.ib.alleenstaande_ouderenkorting', 'Alleenstaande ouderenkorting', 'Crédit d\'impôt, personne âgée seule', 'Alleenstaande ouderenkorting', 'nl.ib', 'EUR', 'verlaagt_last',
  'https://www.belastingdienst.nl', 'Belastingdienst, heffingskortingen', 'Belastingdienst', 'jaarlijks',
...
G('p.nl.ib.aftrektarief_hypotheekrente', 'Maximaal aftrektarief hypotheekrente', 'Taux maximal de déduction des intérêts', 'Tariefaanpassing aftrekposten', 'nl.ib', 'fractie', 'verlaagt_last',
...
G('p.fr.sociaal.pass', 'Plafond annuel de la sécurité sociale', 'Plafond annuel de la sécurité sociale', 'PASS', 'fr.sociaal', 'EUR/jaar', 'bepaalt_grondslag',
  'https://www.urssaf.fr', 'Urssaf, plafond de la sécurité sociale', 'Urssaf', 'jaarlijks',
  'Het PASS is de rekeneenheid achter tientallen Franse drempels, waaronder de Urssaf-drempel voor chambres d\'hôtes die nu als los bedrag in een handboek staat.'),
...
G('p.fr.sociaal.smic', 'SMIC, wettelijk minimumloon', 'SMIC horaire et mensuel', 'Salaire minimum interprofessionnel de croissance', 'fr.sociaal', 'EUR', 'bepaalt_grondslag',
  'https://www.service-public.fr/particuliers/vosdroits/F2300', 'service-public.fr, fiche F2300', 'Ministère du travail', 'jaarlijks',
  'Referentiepunt voor drempels in het arbeids- en socialezekerheidsrecht.'),

G('p.fr.ir.seuil_declaration', 'Aangiftedrempel impôt sur le revenu', 'Seuil de déclaration de revenus', null, 'fr.ir', 'EUR', 'bepaalt_toepasselijkheid',
  'https://www.impots.gouv.fr', 'impots.gouv.fr, obligation de déclarer', 'DGFiP', 'jaarlijks',
  'Bepaalt of er überhaupt aangifte moet worden gedaan. Voor een niet-resident met alleen Frans vastgoedinkomen is dat de eerste vraag.', { vt: 'drempel' }),
...
G('p.fr.ir.contribution_haut_revenus', 'Contribution exceptionnelle sur les hauts revenus', 'Contribution exceptionnelle sur les hauts revenus', 'CEHR, art. 223 sexies CGI', 'fr.ir', 'EUR en procent', 'verhoogt_last',
  ...
  'Komt bovenop de gewone schijven vanaf een revenu fiscal de référence van enkele honderdduizenden euro\'s. Ontbreekt in alle tools.'),
...
G('p.fr.tf.taxe_fonciere', 'Taxe foncière', 'Taxe foncière sur les propriétés bâties', 'TFPB', 'fr.tf', 'procent', 'verhoogt_last',
  SP('F59'), 'service-public.fr, taxe foncière sur les propriétés bâties', 'DGFiP en gemeenten', 'jaarlijks',
...
G('p.fr.tf.revalorisation_valeurs_locatives', 'Jaarlijkse herwaardering van de valeur locative', 'Revalorisation forfaitaire des valeurs locatives', null, 'fr.tf', 'procent', 'bepaalt_grondslag',
  ...
  'De grondslag van taxe foncière en taxe d\'habitation wordt jaarlijks bij wet geïndexeerd. Zonder die factor is een meerjarige raming van de vaste lasten onmogelijk.'),

G('p.fr.cfe.minimum', 'Cotisation foncière des entreprises, minimumbijdrage', 'CFE, base minimum', null, 'fr.cfe', 'EUR', 'verhoogt_last',
  'https://www.impots.gouv.fr', 'impots.gouv.fr, cotisation foncière des entreprises', 'DGFiP en gemeenten', 'jaarlijks',
  'Elke micro-entrepreneur krijgt hiermee te maken na het eerste jaar. De CVAE-drempel staat wel in het register, de CFE niet.'),

G('p.fr.tva.tarif_intermediaire', 'Btw-tarief, tussentarief', 'Taux intermédiaire de TVA', 'Art. 279 CGI', 'fr.tva', 'procent', 'verhoogt_last',
...
G('p.fr.succ.abattement_handicap', 'Extra vrijstelling bij handicap', 'Abattement supplémentaire, personne handicapée', 'Art. 779 II CGI', 'fr.succ', 'EUR', 'verlaagt_last',
  SP('F14198'), 'service-public.fr; art. 779 II CGI', 'DGFiP', 'zelden',
  'Cumuleert met de andere vrijstellingen.', { vt: 'abattement' }),

G('p.fr.succ.vrijstelling_echtgenoot', 'Vrijstelling echtgenoot en PACS-partner', 'Exonération du conjoint survivant et du partenaire pacsé', 'Art. 796-0 bis CGI', 'fr.succ', 'tekst', 'verlaagt_last',
...
G('p.xb.verdrag.artikel_dividend', 'Bronheffing op dividend onder het verdrag', 'Retenue à la source sur les dividendes', 'Art. 10 verdrag NL-FR 1973', 'xb.verdrag', 'procent', 'verhoogt_last',
...
G('p.xb.verdrag.voorkomingsmethode', 'Methode ter voorkoming van dubbele belasting', 'Méthode d\'élimination de la double imposition', 'Art. 24 verdrag NL-FR 1973', 'xb.verdrag', 'tekst', 'verlaagt_last',
...
G('p.xb.vo883.aanwijsregel', 'Aanwijsregel van de toepasselijke socialezekerheidswetgeving', 'Règle de détermination de la législation applicable', 'Titel II, art. 11 tot en met 16 Vo. 883/2004', 'xb.vo883', 'tekst', 'bepaalt_toepasselijkheid',
...
G('p.xb.s1.recht_en_geldigheid', 'S1, recht en geldigheidsduur', 'Formulaire S1, droit et durée de validité', 'Art. 24 en 25 Vo. 883/2004', 'xb.s1', 'tekst', 'bepaalt_toepasselijkheid',
...
G('p.xb.ehic.geldigheidsduur', 'Europese ziekteverzekeringskaart, geldigheidsduur', 'Carte européenne d\'assurance maladie, durée', null, 'xb.ehic', 'jaren', 'bepaalt_toepasselijkheid',
...
G('p.fr.assur.habitation_verplicht', 'Verplichte opstal- en inboedelverzekering', 'Assurance habitation obligatoire', 'Art. 7 g loi 89-462', 'fr.assur', 'tekst', 'bepaalt_toepasselijkheid',
  'https://www.service-public.fr/particuliers/vosdroits/F2123', 'service-public.fr, assurance habitation; art. 7 g loi 89-462', 'Ministère de l\'économie', 'zelden',
  'Voor een huurder wettelijk verplicht, voor een eigenaar in een copropriété eveneens. Staat in geen enkele tool.'),
...
G('p.fr.assur.auto_rc_verplicht', 'Verplichte WA-autoverzekering', 'Assurance automobile obligatoire', 'Art. L211-1 Code des assurances', 'fr.assur', 'tekst', 'bepaalt_toepasselijkheid',
  'https://www.service-public.fr/particuliers/vosdroits/F2123', 'art. L211-1 Code des assurances', 'Ministère de l\'économie', 'zelden',
...
G('p.fr.assur.dommages_ouvrage', 'Assurance dommages-ouvrage', 'Assurance dommages-ouvrage', 'Art. L242-1 Code des assurances', 'fr.assur', 'procent', 'verhoogt_last',
  'https://www.service-public.fr/particuliers/vosdroits/F2129', 'art. L242-1 Code des assurances', 'Ministère de l\'économie', 'zelden',
  'Verplicht voor wie als particulier laat bouwen of ingrijpend laat verbouwen, en een reële kostenpost bij elke renovatie. Ontbreekt in de renovatietools.'),

G('p.fr.assur.garantie_decennale', 'Garantie décennale van de aannemer', 'Garantie décennale', 'Art. 1792 Code civil', 'fr.assur', 'jaren', 'bepaalt_toepasselijkheid',
  'https://www.service-public.fr/particuliers/vosdroits/F2034', 'art. 1792 Code civil', 'Ministère de la justice', 'zelden',
  'De tienjarige aansprakelijkheid van de aannemer. Bepalend bij elke aankoop van een recent verbouwd pand.'),

G('p.fr.mutuelle.premie_indicatie', 'Premie-indicatie complémentaire santé', 'Prix indicatif d\'une mutuelle', null, 'fr.mutuelle', 'EUR/maand', 'verhoogt_last',
  'https://www.service-public.fr', 'marktoverzicht, bron nog te kiezen', 'geen enkele instantie, marktgegeven', 'jaarlijks',
  'ZorgKompas rekent met vergoedingspercentages van de Sécurité sociale maar kent geen premie voor de aanvullende verzekering. Zonder die premie is het beeld van de zorgkosten onvolledig. Dit is een marktgegeven en krijgt bij vulling klasse marktindex met een verantwoordelijke en een houdbaarheidsdatum.',
...
G('p.fr.diagnostics.verplichte_diagnoses_kosten', 'Kosten van het verplichte diagnosepakket', 'Coût du dossier de diagnostic technique', 'Art. L271-4 Code de la construction', 'fr.diagnostics', 'EUR', 'verhoogt_last',
  ...
  'De verkoper betaalt het volledige diagnosepakket. Alleen het diagnostic électrique staat nu in het register, en dan nog alleen de geldigheidsduur.',
