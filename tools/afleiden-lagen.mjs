...
const rekenregels = [
  ...
  R({
    ...
    omschrijving: 'Over de voor de inkomstenbelasting belastbare meerwaarde wordt het vaste tarief geheven. Over de voor de sociale lasten belastbare meerwaarde worden de prelevements sociaux geheven, tenzij het arrest De Ruyter van toepassing is; dan blijft alleen het prelevement de solidarite over.',
    ...
    tests: [{ invoer: 'belastbare meerwaarde 100.000 euro, geen De Ruyter', verwachte_uitkomst: '19.000 euro inkomstenbelasting en 17.200 euro sociale lasten, samen 36.200 euro', toelichting: 'Zonder surtaxe.' },
            { invoer: 'belastbare meerwaarde 100.000 euro, wel De Ruyter', verwachte_uitkomst: '19.000 euro inkomstenbelasting en 7.500 euro prelevement de solidarite, samen 26.500 euro', toelichting: 'Dit is de 26,5 procent die Cafe Claude noemt tegenover 36,2 procent.' }],
  }),
  R({
    id: 'r.fr.pv.surtaxe', reg: 'fr.pv',
    nl: 'Surtaxe op hoge meerwaarden',
    fr: 'Taxe sur les plus-values elevees',
  ...
  R({
    ...
    omschrijving: 'De som van de emolumenten van de notaris met btw, de droits de mutation (departementaal deel plus frais d assiette, plus taxe communale), de contribution de securite immobiliere en de debours. Eventueel verminderd met de wettelijke korting op de emolumenten.',
    ...
    kn: 'art. A444-91 Code de commerce, art. 1584, 1594 D, 1647 en 879 CGI', bs: 'primair', inst: 'DGFiP en Conseil superieur du notariat',
    vd: '2026-08-12', vdoor: 'Vastgoedtransactie, bronnen.json',
    in: [['Vastgoedtransactie', 'calc.js, kernberekening', null, false]],
    tests: [{ invoer: 'bestaande woning, 250.000 euro, departement met 5,00 procent, geen primo-accedant', verwachte_uitkomst: 'kosten koper van ongeveer 7,4 procent van de koopsom', toelichting: 'De vuistregel van 7 tot 8 procent klopt hier ruwweg, maar niet in een departement met 4,50 procent en niet bij een primo-accedant.' }],
  ...
  R({
    ...
    fr: 'Montant de l allocation sante',
  ...
  R({
    ...
    nl: 'Impot sur le revenu na plafonnering en decote',
    fr: 'Impot sur le revenu apres plafonnement et decote',
    omschrijving: 'Het belastbaar inkomen wordt gedeeld door het aantal parts, door het barema gehaald en weer vermenigvuldigd met het aantal parts. Het voordeel van de extra halve parts wordt geplafonneerd. Daarna volgt de decote en pas daarna komen belastingkortingen en belastingkredieten.',
    ...
    tests: [{ invoer: 'echtpaar, 2 parts, belastbaar inkomen 40.000 euro', verwachte_uitkomst: 'belasting volgens het barema over 20.000 euro per part, maal 2, daarna de decote toetsen', toelichting: 'De volgorde is bepalend: de decote pas na de plafonnering.' }],
  ...
  R({
    ...
    fr: 'Determination du taux de CSG applicable',
    omschrijving: 'Het revenu fiscal de reference van twee jaar terug wordt vergeleken met de grenzen die horen bij het aantal parts. Boven drie parts komt er per halve part een opslag bij. De uitkomst wijst een van de vier regimes aan.',
    ...
    tests: [{ invoer: 'RFR 2024 van 18.000 euro, 1 part', verwachte_uitkomst: 'taux median, 7,4 procent', toelichting: '18.000 ligt tussen 17.057 en 26.472 euro.' }],
...
writeFileSync(join(WORTEL, 'data', 'duidingsregels.json'), JSON.stringify({
  meta: meta('1, duidingsregels', { stand: 'leeg: in taak 1 is alleen het schema opgeleverd. De vulling wordt later geindexeerd over de handboeken van Cafe Claude.' }),
  duidingsregels: [],
}, null, 1) + '\n');

writeFileSync(join(WORTEL, 'data', 'documenten.json'), JSON.stringify({
  meta: meta('documentenregister', { stand: 'leeg: in taak 1 is alleen het schema opgeleverd. De inventarisatie van de handboeken en PDF s van Cafe Claude valt buiten deze taak.' }),
  documenten: [],
}, null, 1) + '\n');
